...
#Crição do algoritmo randoom forest usando a base de treinamento
...
v = ConfusionMatrix(rf)
v.fit(X_treinamento, y_treinamento)
v.score(X_teste, y_teste)
v.poof()

''' A taxa de acerto do modelo foi de 93,8%, aproximadamente, com 30% dos dados para teste.'''